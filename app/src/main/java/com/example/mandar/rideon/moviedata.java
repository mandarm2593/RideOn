...
public class moviedata {
    ...
    public moviedata(){
        ...
        moviesList.add(createMovie("Avatar", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "1997";
        length = "194 min";
        rating = 7.7;
        ...
        moviesList.add(createMovie("Titanic", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2012";
        length = "143 min";
        rating = 8.2;
        ...
        moviesList.add(createMovie("The Avengers", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2008";
        length = "152 min";
        rating = 9.0;
        ...
        moviesList.add(createMovie("The Dark Knight", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "1999";
        length = "136 min";
        rating = 6.6;
        ...
        moviesList.add(createMovie("Star Wars I", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "1977";
        length = "121 min";
        rating = 8.7;
        director = "George Lucas" ;
        ...
        moviesList.add(createMovie("Star Wars IV ", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2012";
        length = "165 min";
        rating = 8.6;
        director = "Christopher Nolan" ;
        ...
        moviesList.add(createMovie("The Dark Knight Rises", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2004";
        length = "93 min";
        rating = 7.3;
        ...
        moviesList.add(createMovie("Shrek 2", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "1982";
        length = "115 min";
        rating = 7.9;
        ...
        moviesList.add(createMovie("E.T. the Extra-Terrestrial", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2013";
        length = "146 min";
        rating = 7.8;
        ...
        moviesList.add(createMovie("The Hunger Games: Catching Fire", R.drawable.done, description, year, length, rating, director, stars, url));
        ...
        moviesList.add(createMovie("Pirates of the Caribbean: Dead Man's Chest", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "1994";
        length = "89 min";
        rating = 8.5;
        ...
        moviesList.add(createMovie("The Lion King", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2010";
        length = "103 min";
        rating = 8.4;
        ...
        moviesList.add(createMovie("Toy Story 3", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2013";
        length = "130 min";
        rating = 7.4;
        ...
        moviesList.add(createMovie("Iron Man 3", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2012";
        length = "142 min";
        rating = 7.3;
        director = "Gary Ross" ;
        ...
        moviesList.add(createMovie("The Hunger Games", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2002";
        length = "121 min";
        rating = 7.3;
        director = "Sam Raimi" ;
        ...
        moviesList.add(createMovie("Spider-Man", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "1993";
        length = "127 min";
        rating = 8.0;
        director = "Steven Spielberg" ;
        ...
        moviesList.add(createMovie("Jurassic Park", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2009";
        length = "150 min";
        rating = 6.0;
        ...
        moviesList.add(createMovie("Transformers: Revenge of the Fallen", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2013";
        length = "102 min";
        rating = 7.9;
        ...
        moviesList.add(createMovie("Frozen", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2011";
        length = "130 min";
        rating = 8.1;
        ...
        moviesList.add(createMovie("Harry Potter and the Deathly Hallows: Part 2", R.drawable.done, description, year, length, rating, director, stars, url));
        //#21-30
        year = "2003";
        length = "100 min";
        rating = 8.2;
        ...
        moviesList.add(createMovie("Finding Nemo", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2005";
        length = "140 min";
        rating = 7.7;
        director = "George Lucas" ;
        ...
        moviesList.add(createMovie("Star Wars III", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2003";
        length = "201 min";
        rating = 8.9;
        ...
        moviesList.add(createMovie("The Lord of the Rings: The Return of the King", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2004";
        length = "127 min";
        rating = 7.4;
        director = "Sam Raimi" ;
        ...
        moviesList.add(createMovie("Spider-Man 2", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2013";
        length = "98 min";
        rating = 7.6;
        ...
        moviesList.add(createMovie("Despicable Me 2", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2011";
        length = "154 min";
        rating = 6.4;
        director = "Michael Bay" ;
        ...
        moviesList.add(createMovie("Transformers: Dark of the Moon", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2002";
        length = "179 min";
        rating = 8.8;
        director = "Peter Jackson" ;
        ...
        moviesList.add(createMovie("The Lord of the Rings: The Two Towers", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2007";
        length = "139 min";
        rating = 6.3;
        director = "Sam Raimi" ;
        ...
        moviesList.add(createMovie("Spider-Man 3", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "2010";
        length = "108 min";
        rating = 6.5;
        director = "Tim Burton" ;
        ...
        moviesList.add(createMovie("Alice in Wonderland", R.drawable.done, description, year, length, rating, director, stars, url));
        year = "1994";
        length = "145 min";
        rating = 8.8;
        ...
        moviesList.add(createMovie("Forrest Gump", R.drawable.done, description, year, length, rating, director, stars, url));
    }
